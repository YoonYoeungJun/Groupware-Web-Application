...
namespace eniFramework.WebApp.Modules.Mail {
    public class V_MAIL_RECIPIENTS_CHECKMapCN : EntityTypeConfiguration<V_MAIL_RECIPIENTS_CHECK_CN> {
        public V_MAIL_RECIPIENTS_CHECKMapCN() {
            ...
            this.Property(t => t.SENDSTATUSNAME).HasColumnName("SENDSTATUSNAME_CN");
