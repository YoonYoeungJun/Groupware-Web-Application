...
namespace eniFramework.WebApp.Modules.Mail {
    public class V_MAIL_MESSAGESMapCN : EntityTypeConfiguration<V_MAIL_MESSAGES_CN> {
        public V_MAIL_MESSAGESMapCN() {
            //this.HasKey(t => new {
            //    t.MESSAGEID,
            //    t.MESSAGEFOLDERID,
            //    t.MESSAGEFLAGED
            ...
            this.Property(t => t.MESSAGEFOLDERNAME).HasColumnName("MESSAGEFOLDERNAME_CN");
            ...
            this.Property(t => t.MESSAGEFROMADDRESS).HasColumnName("MESSAGEFROMADDRESS_CN");
            this.Property(t => t.MESSAGETOADDRESS).HasColumnName("MESSAGETOADDRESS_CN");
            this.Property(t => t.MESSAGESUBJECT).HasColumnName("MESSAGESUBJECT_CN");
