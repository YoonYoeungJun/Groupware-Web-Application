...
namespace eniFramework.WebApp.Modules.Mail {
    public class V_MAIL_MESSAGESMapJP : EntityTypeConfiguration<V_MAIL_MESSAGES_JP> {
        public V_MAIL_MESSAGESMapJP() {
            //this.HasKey(t => new {
            //    t.MESSAGEID,
            //    t.MESSAGEFOLDERID,
            //    t.MESSAGEFLAGED
            ...
            this.Property(t => t.MESSAGEFOLDERNAME).HasColumnName("MESSAGEFOLDERNAME_JP");
            ...
            this.Property(t => t.MESSAGEFROMADDRESS).HasColumnName("MESSAGEFROMADDRESS_JP");
            this.Property(t => t.MESSAGETOADDRESS).HasColumnName("MESSAGETOADDRESS_JP");
            this.Property(t => t.MESSAGESUBJECT).HasColumnName("MESSAGESUBJECT_JP");
