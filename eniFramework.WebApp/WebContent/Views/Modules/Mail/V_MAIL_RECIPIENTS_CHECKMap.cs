...
namespace eniFramework.WebApp.Modules.Mail {
    public class V_MAIL_RECIPIENTS_CHECKMap : EntityTypeConfiguration<V_MAIL_RECIPIENTS_CHECK> {
        public V_MAIL_RECIPIENTS_CHECKMap() {
            ...
            this.Property(t => t.SENDSTATUSNAME).HasColumnName("SENDSTATUSNAME_KO");
