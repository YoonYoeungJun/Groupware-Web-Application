...
namespace eniFramework.WebApp.Modules.Mail {
    public class V_MAIL_RECIPIENTS_CHECKMapJP : EntityTypeConfiguration<V_MAIL_RECIPIENTS_CHECK_JP> {
        public V_MAIL_RECIPIENTS_CHECKMapJP() {
            ...
            this.Property(t => t.SENDSTATUSNAME).HasColumnName("SENDSTATUSNAME_JP");
