<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WebContent/Common/CommonPage.Master" CodeBehind="B2003MA1.aspx.cs" Inherits="eniFramework.WebApp.Modules.B2.B2003MA1" %>
...
<asp:Content ContentPlaceHolderID="Sub_Module_Description" runat="server">
    ...
    *  1. Module Name          : 어드민
    *  2. Function Name        :
    *  3. Program ID           : B2003MA1.aspx
    *  4. Program Name         : 시스템권한정보관리
    *  5. Program Desc         : 시스템권한정보관리
    *  6. Comproxy List        :
...
<asp:Content ContentPlaceHolderID="Sub_Script_Holder" runat="server">
    <script type="text/javascript">
        try {
            var B2003MA1 = eni.Initialize(new function () {
                lgPageRowCount = 100;
                ...
                this.InitSpreadSheet = function () {
                    try {
                        ...
                        ggoSpread.SSSetEdit(C_USR_ROLE_ID, "<%= GetResource("CSTRESX00002") %>", 10, HAlign.Left, 20, CellKind.Protected, false, EditCharCase.UpperCase);
                        ggoSpread.SSSetEdit(C_USR_ROLE_NM, "<%= GetResource("CSTRESX00003") %>", 20, HAlign.Left, 50, CellKind.Required);
                        ggoSpread.SSSetEdit(C_USR_ROLE_NM_KO, "<%= GetResource("CSTRESX00004") %>", 20, HAlign.Left, 50, CellKind.Required, false, EditCharCase.NoCase);
                        ggoSpread.SSSetEdit(C_USR_ROLE_NM_EN, "<%= GetResource("CSTRESX00005") %>", 20, HAlign.Left, 50, CellKind.Required, false, EditCharCase.NoCase);
                        ggoSpread.SSSetEdit(C_USR_ROLE_NM_CN, "<%= GetResource("CSTRESX00006") %>", 20, HAlign.Left, 50, CellKind.Required, false, EditCharCase.NoCase);
                        ggoSpread.SSSetEdit(C_USR_ROLE_NM_JP, "<%= GetResource("CSTRESX00007") %>", 20, HAlign.Left, 50, CellKind.Required, false, EditCharCase.NoCase);
                ...
                this.OnFncInsertRow = function () {
                    try {
                        ...
                        ggoSpread.SpreadRequired(C_USR_ROLE_NM, activeRow);
                        ggoSpread.SpreadRequired(C_USR_ROLE_NM_KO, activeRow);
                        ggoSpread.SpreadRequired(C_USR_ROLE_NM_EN, activeRow);
                        ggoSpread.SpreadRequired(C_USR_ROLE_NM_CN, activeRow);
                        ggoSpread.SpreadRequired(C_USR_ROLE_NM_JP, activeRow);
                ...
                this.cntxtUserRole_PopupButtonClick = function (s, e) {
                    try {
                        ...
                        popArgs.Title = "<%= GetResource("CSTRESX00008") %>";
                ...
                this.DbSave = function () {
                    try {
                        ...
                        var tbData = dsData.CreateDataTable("B2003MA1");
                                    ...
                                    <ContentCollection>
                                        <dx:SplitterContentControl>
                                            <table class="BSL01TB" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <th class="TH4C">
                                                        <span class="CAP" onclick="cntxtUserRole.Focus()"><%= GetResource("CSTRESX00002")%></span>
                                                    </th>
                                                    <td class="TD4F">
