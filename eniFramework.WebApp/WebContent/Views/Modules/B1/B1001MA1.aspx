<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WebContent/Common/CommonPage.Master" CodeBehind="B1001MA1.aspx.cs" Inherits="eniFramework.WebApp.Modules.B1.B1001MA1" %>
...
<asp:Content ContentPlaceHolderID="Sub_Module_Description" runat="server">
    ...
    *  1. Module Name          : 시스템설정
    *  2. Function Name        :
    *  3. Program ID           : B1001MA1.aspx
    *  4. Program Name         : MINOR 코드 등록
    *  5. Program Desc         : MINOR 코드 등록
    *  6. Comproxy List        :
...
<asp:Content ContentPlaceHolderID="Sub_Script_Holder" runat="server">
    <script type="text/javascript">
        try {
            var B1001MA1 = eni.Initialize(new function () {
                lgPageRowCount = 100;
                ...
                this.InitSpreadSheet = function () {
                    try {
                        ...
                        ggoSpread.SSSetEdit(C_MINOR_NM, "<%= GetResource("CSTRESX00004") %>", 20, HAlign.Left, 50, CellKind.Required);
                        ggoSpread.SSSetEdit(C_MINOR_NM_KO, "<%= GetResource("CSTRESX00005") %>", 20, HAlign.Left, 50, CellKind.Required);
                        ggoSpread.SSSetEdit(C_MINOR_NM_EN, "<%= GetResource("CSTRESX00006") %>", 20, HAlign.Left, 50, CellKind.Required);
                        ggoSpread.SSSetEdit(C_MINOR_NM_CN, "<%= GetResource("CSTRESX00007") %>", 20, HAlign.Left, 50, CellKind.Required);
                        ggoSpread.SSSetEdit(C_MINOR_NM_JP, "<%= GetResource("CSTRESX00008") %>", 20, HAlign.Left, 50, CellKind.Required);
                        ggoSpread.SSSetCombo(C_MINOR_TYPE, "", 10, HAlign.Center, null, true, "U" + vspdData.ColSep + "S");
                        ggoSpread.SSSetCombo(C_MINOR_TYPE_NM, "<%= GetResource("CSTRESX00009") %>", 15, HAlign.Center, CellKind.Protected, false, "<%= GetResource("CSTRESX00011") %>" + vspdData.ColSep + "<%= GetResource("CSTRESX00012") %>");
                ...
                this.OnFncInsertRow = function () {
                    try {
                        ...
                        ggoSpread.SpreadRequired(C_MINOR_TYPE_NM, activeRow);

                        ggoSpread.SetText(C_MAJOR_CD, activeRow, cntxtMajor.GetText());
                        ggoSpread.SetValue(C_MINOR_TYPE, activeRow, 0);
                        ggoSpread.SetValue(C_MINOR_TYPE_NM, activeRow, 0);
                ...
                this.OnFncCopyRow = function () {
                    try {
                        ...
                        if (ggoSpread.Source.MaxRows == 0) {
                            ...
                            ggoSpread.SpreadRequired(C_MAJOR_CD, copy_row, C_MINOR_NM_JP, copy_row);
                            ggoSpread.SpreadRequired(C_MINOR_TYPE_NM, copy_row);

                            ggoSpread.SetText(C_MAJOR_CD, copy_row, ggoSpread.GetText(C_MAJOR_CD, active_row, false));
                            ggoSpread.SetText(C_MINOR_NM, copy_row, ggoSpread.GetText(C_MINOR_NM, active_row, false));
                            ggoSpread.SetText(C_MINOR_NM_KO, copy_row, ggoSpread.GetText(C_MINOR_NM_KO, active_row, false));
                            ggoSpread.SetText(C_MINOR_NM_EN, copy_row, ggoSpread.GetText(C_MINOR_NM_EN, active_row, false));
                            ggoSpread.SetText(C_MINOR_NM_CN, copy_row, ggoSpread.GetText(C_MINOR_NM_CN, active_row, false));
                            ggoSpread.SetText(C_MINOR_NM_JP, copy_row, ggoSpread.GetText(C_MINOR_NM_JP, active_row, false));
                            ggoSpread.SetText(C_MINOR_TYPE, copy_row, ggoSpread.GetText(C_MINOR_TYPE, active_row, false));
                            ggoSpread.SetText(C_MINOR_TYPE_NM, copy_row, ggoSpread.GetText(C_MINOR_TYPE_NM, active_row, false));
                ...
                this.vspdData_ComboSelChange = function (pSender, pCol, pRow) {
                    try {
                        ...
                        switch (pCol) {
                            case C_MINOR_TYPE: ggoSpread.SetValue(C_MINOR_TYPE_NM, pRow, ggoSpread.GetValue(pCol, pRow)); break;
                            case C_MINOR_TYPE_NM: ggoSpread.SetValue(C_MINOR_TYPE, pRow, ggoSpread.GetValue(pCol, pRow)); break;
                        }
                    } catch (ex) {
                        eni.Message.DisplayMsgBox(eni.Message.StrBundle("MSGBD00003"), ex.message);
                    }
                ...
                this.DbSave = function () {
                    try {
                        ...
                        var tbData = dsData.CreateDataTable("B1001MA1");
                        ...
                        for (var i = 1; i < ggoSpread.Source.MaxRows + 1; i++) {
                            switch (ggoSpread.GetText(0, i)) {
                                case ggoSpread.Source.InsertFlag:
                                    ...
                                    nRow.MINOR_TYPE = ggoSpread.GetText(C_MINOR_TYPE, i, true);
