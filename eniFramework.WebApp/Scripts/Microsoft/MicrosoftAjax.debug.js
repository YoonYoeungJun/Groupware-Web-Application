    ...
    if (this._enableHistory) {
        ...
        if (entry !== this._currentEntry) {
            ...
            if (this._historyFrame && this._historyPointIsNew) {
                ...
                frameDoc.open("javascript:'<html xmlns="http://www.w3.org/1999/xhtml"></html>'");
                frameDoc.write("<html xmlns="http://www.w3.org/1999/xhtml"><head><title>" + (title || document.title) +
